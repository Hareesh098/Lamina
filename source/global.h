...
EXTERN double	*rx, *ry, *vx, *vy, *ax, *ay, *fx, *fy;
EXTERN double	*speed;

EXTERN double region[NDIM+1], regionH[NDIM+1], deltaT, timeNow, potEnergy, kinEnergy, totEnergy, density, 
...
EXTERN double mass; //mass from input file
...
EXTERN double InterfaceWidth, bigDiameter;
EXTERN int  nAtomInterface,  nDiscInterface, nAtomBlock;
EXTERN int  *atomIDInterface;
EXTERN int BondPairFlag;
EXTERN int nAtomInterfaceTotal; //The endLoop index in the ComputePairForce
